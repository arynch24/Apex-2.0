...
export function FeaturesSectionDemo() {
  ...
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto -my-44">
      <div className="px-8">
        <h4
          className="text-3xl lg:text-5xl lg:leading-tight max-w-6xl mx-auto text-center tracking-tight font-medium text-black dark:text-white">
          Apex Fashion School isn't just a place to learn fashion—
        </h4>

        <p
          className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          it's an incubator for future fashion leaders, We don’t teach you how to sketch; we teach you how to launch and scale a profitable fashion brand.
        </p>
      </div>
